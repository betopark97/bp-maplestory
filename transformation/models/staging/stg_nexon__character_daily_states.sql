with scheduler_character_state as (
    ...
    from {{ source('nexon', 'scheduler_character_state') }}
),
...
daily_contents as (
    select
        ...
        (content ->> 'registration_flag')::boolean as is_daily_contents__registered,
        ...
        cast(null as boolean) as is_weekly_contents__registered,
        ...
        cast(null as boolean) as is_boss_contents__completed,
        cast(null as integer) as boss_contents__list_order_no,
        cast(null as boolean) as is_boss_contents__registered
    from scheduler_character_state,
...
weekly_contents as (
    select
        ...
        cast(null as boolean) as is_daily_contents__registered,
        ...
        (content ->> 'registration_flag')::boolean as is_weekly_contents__registered,
        cast(null as text) as boss_contents__cycle,
        cast(null as text) as boss_contents__difficulty,
        cast(null as text) as boss_contents__content_name,
        cast(null as boolean) as is_boss_contents__completed,
...
boss_contents as (
    select
        ...
        (content ->> 'complete_flag')::boolean as is_boss_contents__completed,
        (content ->> 'list_order_no')::integer as boss_contents__list_order_no,
        (content ->> 'registration_flag')::boolean as is_boss_contents__registered
    from scheduler_character_state,
...
stg_nexon__character_daily_states as (
    select
        spine.snapshot_date,
        spine.ocid,
        ...
        all_lists.is_daily_contents__registered,
