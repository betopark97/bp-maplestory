with character_ring_reserve_skill_equipment as (
    ...
    from {{ source('nexon', 'character_ring_reserve_skill_equipment') }}
),

stg_nexon__character_ring_reserve_skills as (
    select
        snapshot_date::date,
        ocid,
        character_class,
...
select * from stg_nexon__character_ring_reserve_skills
