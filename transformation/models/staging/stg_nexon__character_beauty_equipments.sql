with character_beauty_equipment as (
    ...
    from {{ source('nexon', 'character_beauty_equipment') }}
),

stg_nexon__character_beauty_equipments as (
    select
        snapshot_date,
        ocid,
        character_gender,
        ...
        (character_hair ->> 'freestyle_flag')::boolean as is_character_hair__freestyle,
        ...
        (character_face ->> 'freestyle_flag')::boolean as is_character_face__freestyle,
...
select * from stg_nexon__character_beauty_equipments
